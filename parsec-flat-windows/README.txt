...
3. The "wscripts" directory contains various scripts used by the Parsec installer to install the System Service, Windows Firewall rules, and the Parsec Virtual USB.

4. The "vusb" directory contains the Parsec Virtual USB driver used for wacom and gamepad input.
